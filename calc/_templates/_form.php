                        ...
                        <div id="form-content" class="col-md-8">
                            <form id="survey-form" onsubmit="return false;"> <!-- open form -->
                                ...
                                <div class="row form-group">
                                   <div class="col-sm-3">
                                    <label id="name-label" class="control-label" for="name">*Security Charges:</label>
                                   </div>
                                   ...
                                   <div class="input-group col-sm-9">
                                     ...
                                     <input id="name" type="text" class="form-control" placeholder="Please Enter Your Charges" name="name" required>
                                   </div>
                                </div>
                                 
                                <div class="form-group row">
                                   <div class="col-sm-3">
                                     <label id="email-label" class="control-label" for="email">*Road Width:</label>
                                   </div>
                                   ...
                                   <div class="input-group col-sm-9">
                                     ...
                                     <input type="email" class="form-control" id="email" placeholder="Enter Your Road Width" name="email" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" required>
                                   </div>
                                </div>
